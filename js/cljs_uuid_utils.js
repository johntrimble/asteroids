...
*/
cljs_uuid_utils.make_random_uuid = (function make_random_uuid(){var f = (function f(){return cljs.core.rand_int(16).toString(16);
});
var g = (function g(){return (8 | (3 & cljs.core.rand_int(15))).toString(16);
});
return (new cljs.core.UUID((new goog.string.StringBuffer()).append(f(),f(),f(),f(),f(),f(),f(),f(),"-",f(),f(),f(),f(),"-4",f(),f(),f(),"-",g(),f(),f(),f(),"-",f(),f(),f(),f(),f(),f(),f(),f(),f(),f(),f(),f())));
});
cljs_uuid_utils.uuid_regex = (function (){var x = "[0-9a-fA-F]";return cljs.core.re_pattern([cljs.core.str("^"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("-"),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str(x),cljs.core.str("$")].join(''));
})();
/**
...
*/
cljs_uuid_utils.valid_uuid_QMARK_ = (function valid_uuid_QMARK_(maybe_uuid){var maybe_uuid_str = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.type(maybe_uuid),cljs.core.UUID))?cljs_uuid_utils.uuid_string(maybe_uuid):((typeof maybe_uuid === 'string')?maybe_uuid:((cljs.core.constant$keyword$16)?false:null)));if(cljs.core.truth_(maybe_uuid_str))
{return cljs.core.re_find(cljs_uuid_utils.uuid_regex,maybe_uuid_str);
} else
{return null;
}
});
...
*/
cljs_uuid_utils.make_uuid_from = (function make_uuid_from(maybe_uuid){var temp__4092__auto__ = cljs_uuid_utils.valid_uuid_QMARK_(maybe_uuid);if(cljs.core.truth_(temp__4092__auto__))
{var uuid = temp__4092__auto__;if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.type(maybe_uuid),cljs.core.UUID))
{return maybe_uuid;
} else
