...
asteroids.projectile.projectile = (function projectile(){return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$17,cljs.core.constant$keyword$101], null);
});
...
var weapon__2 = (function (cooldown,cooldown_remaining){return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$17,cljs.core.constant$keyword$104,cljs.core.constant$keyword$102,cooldown,cljs.core.constant$keyword$103,cooldown_remaining], null);
});
...
{var entity = cljs.core.first(entities);var weapon_comp = asteroids.core.get_component(entity,cljs.core.constant$keyword$104);if(cljs.core.truth_((function (){var and__3419__auto__ = weapon_comp;if(cljs.core.truth_(and__3419__auto__))
{return ((0 === cljs.core.constant$keyword$103.cljs$core$IFn$_invoke$arity$1(weapon_comp))) && (asteroids.core.has_component_QMARK_(entity,cljs.core.constant$keyword$80));
} else
...
var G__5802 = cljs.core.assoc_BANG_(cljs.core.assoc_BANG_(output,asteroids.core.get_id(p),p),asteroids.core.get_id(entity),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(entity,cljs.core.constant$keyword$80));
entities = G__5801;
output = G__5802;
continue;
}
...
return (function (_,entity){var weapon_component = asteroids.core.get_component(entity,cljs.core.constant$keyword$104);return asteroids.core.assoc_component(entity,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(weapon_component,cljs.core.constant$keyword$103,cljs.core.mod((cljs.core.constant$keyword$103.cljs$core$IFn$_invoke$arity$1(weapon_component) - 1),cljs.core.constant$keyword$102.cljs$core$IFn$_invoke$arity$1(weapon_component))));
});})(world__3315__auto__))
...
{var entity__3319__auto__ = cljs.core.first(entities__3317__auto__);if(asteroids.core.has_components_QMARK_.cljs$core$IFn$_invoke$arity$2(entity__3319__auto__,cljs.core.constant$keyword$104))
...
asteroids.projectile.add_damage = (function add_damage(e,dmg){var current_dmg = cljs.core.constant$keyword$73.cljs$core$IFn$_invoke$arity$2(asteroids.core.get_component(e,cljs.core.constant$keyword$73),0);var dmg__$1 = (dmg + current_dmg);return asteroids.core.assoc_component(e,asteroids.health.damage(dmg__$1));
});
asteroids.projectile.projectile_collision_resolution_system = (function projectile_collision_resolution_system(world){return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(world,cljs.core.constant$keyword$45,cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (entity_entries,entity){if(asteroids.core.has_components_QMARK_.cljs$core$IFn$_invoke$arity$3(entity,cljs.core.constant$keyword$101,cljs.core.constant$keyword$62))
{var temp__4090__auto__ = cljs.core.constant$keyword$61.cljs$core$IFn$_invoke$arity$1(asteroids.core.get_component(entity,cljs.core.constant$keyword$62));if(cljs.core.truth_(temp__4090__auto__))
