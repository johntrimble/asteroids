...
return (function (p,v,m){return asteroids.asteroids.create_asteroid(new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$78,asteroids.util.rand_varied_color(asteroids.asteroids.asteroid_color,0.1),cljs.core.constant$keyword$21,v,cljs.core.constant$keyword$24,asteroids.core.get_angular_velocity(entity),cljs.core.constant$keyword$77,(asteroids.math.sqrt.cljs$core$IFn$_invoke$arity$1 ? asteroids.math.sqrt.cljs$core$IFn$_invoke$arity$1((m / asteroids.math.pi)) : asteroids.math.sqrt.call(null,(m / asteroids.math.pi))),cljs.core.constant$keyword$31,p], null));
...
asteroids.asteroids.asteroid_death_system = (function asteroid_death_system(world){return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(asteroids.asteroids.do_explosive_death,world,cljs.core.filter((function (p1__4966_SHARP_){return (1 > cljs.core.constant$keyword$71.cljs$core$IFn$_invoke$arity$1(asteroids.core.get_component(p1__4966_SHARP_,cljs.core.constant$keyword$72)));
}),cljs.core.filter((function (p1__4965_SHARP_){return asteroids.core.has_components_QMARK_.cljs$core$IFn$_invoke$arity$3(p1__4965_SHARP_,cljs.core.constant$keyword$76,cljs.core.constant$keyword$72);
