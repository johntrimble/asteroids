...
var health = null;
var health__1 = (function (health__$1){return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$17,cljs.core.constant$keyword$72,cljs.core.constant$keyword$70,health__$1,cljs.core.constant$keyword$71,health__$1], null);
});
var health__2 = (function (health__$1,remaining){return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$17,cljs.core.constant$keyword$72,cljs.core.constant$keyword$70,health__$1,cljs.core.constant$keyword$71,remaining], null);
});
...
;
asteroids.health.health_bar = (function health_bar(entity_id,width,height){return new cljs.core.PersistentArrayMap(null, 4, [cljs.core.constant$keyword$17,cljs.core.constant$keyword$74,cljs.core.constant$keyword$73,entity_id,cljs.core.constant$keyword$47,width,cljs.core.constant$keyword$48,height], null);
});
asteroids.health.damage = (function damage(damage__$1){return new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$17,cljs.core.constant$keyword$75,cljs.core.constant$keyword$75,damage__$1], null);
});
asteroids.health.get_damage = (function get_damage(entity){return cljs.core.constant$keyword$75.cljs$core$IFn$_invoke$arity$1((health.get_component.cljs$core$IFn$_invoke$arity$2 ? health.get_component.cljs$core$IFn$_invoke$arity$2(entity,cljs.core.constant$keyword$75) : health.get_component.call(null,entity,cljs.core.constant$keyword$75)));
});
...
return (function (world__$1,entity){var impulse = cljs.core.constant$keyword$57.cljs$core$IFn$_invoke$arity$1(asteroids.core.get_component(entity,cljs.core.constant$keyword$58));var current_damage = cljs.core.constant$keyword$75.cljs$core$IFn$_invoke$arity$2(asteroids.core.get_component(entity,cljs.core.constant$keyword$75),0);var impulse_damage = (impulse - 300);if((impulse_damage > 0))
...
{var entity__3319__auto__ = cljs.core.first(entities__3317__auto__);if(asteroids.core.has_components_QMARK_.cljs$core$IFn$_invoke$arity$4(entity__3319__auto__,cljs.core.constant$keyword$72,cljs.core.constant$keyword$58,cljs.core.constant$keyword$40))
...
return (function (_,entity){var current = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(entity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$72,cljs.core.constant$keyword$71], null));var max_health = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(entity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$72,cljs.core.constant$keyword$70], null));var damage = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(entity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$75,cljs.core.constant$keyword$75], null));var current__$1 = (current - damage);return asteroids.core.assoc_component(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(entity,cljs.core.constant$keyword$75),asteroids.health.health.cljs$core$IFn$_invoke$arity$2(max_health,current__$1));
});})(world__3315__auto__))
;var entities__3317__auto__ = asteroids.core.get_entities(world__3315__auto__);var output__3318__auto__ = cljs.core.transient$(cljs.core.constant$keyword$45.cljs$core$IFn$_invoke$arity$1(world__3315__auto__));while(true){
if(cljs.core.seq(entities__3317__auto__))
{var entity__3319__auto__ = cljs.core.first(entities__3317__auto__);if(asteroids.core.has_components_QMARK_.cljs$core$IFn$_invoke$arity$3(entity__3319__auto__,cljs.core.constant$keyword$75,cljs.core.constant$keyword$72))
{var result__3320__auto__ = f__3316__auto__(world__3315__auto__,entity__3319__auto__);{
...
{var entity_5101 = chunk__5089_5098.cljs$core$IIndexed$_nth$arity$2(null,i__5091_5100);if(asteroids.core.has_components_QMARK_.cljs$core$IFn$_invoke$arity$4(entity_5101,cljs.core.constant$keyword$74,cljs.core.constant$keyword$50,cljs.core.constant$keyword$31))
{var disp_5102 = cljs.core.constant$keyword$49.cljs$core$IFn$_invoke$arity$1(asteroids.core.get_component(entity_5101,cljs.core.constant$keyword$50));var health_bar_comp_5103 = asteroids.core.get_component(entity_5101,cljs.core.constant$keyword$74);var target_id_5104 = cljs.core.constant$keyword$73.cljs$core$IFn$_invoke$arity$1(health_bar_comp_5103);var target_5105 = asteroids.core.get_entity(world,target_id_5104);var target_health_comp_5106 = asteroids.core.get_component(target_5105,cljs.core.constant$keyword$72);var max_health_5107 = cljs.core.constant$keyword$70.cljs$core$IFn$_invoke$arity$1(target_health_comp_5106);var remaining_health_5108 = cljs.core.constant$keyword$71.cljs$core$IFn$_invoke$arity$1(target_health_comp_5106);var percentage_5109 = (function (){var x__3738__auto__ = 0;var y__3739__auto__ = (remaining_health_5108 / max_health_5107);return ((x__3738__auto__ > y__3739__auto__) ? x__3738__auto__ : y__3739__auto__);
...
{var entity_5135 = cljs.core.first(seq__5087_5129__$1);if(asteroids.core.has_components_QMARK_.cljs$core$IFn$_invoke$arity$4(entity_5135,cljs.core.constant$keyword$74,cljs.core.constant$keyword$50,cljs.core.constant$keyword$31))
{var disp_5136 = cljs.core.constant$keyword$49.cljs$core$IFn$_invoke$arity$1(asteroids.core.get_component(entity_5135,cljs.core.constant$keyword$50));var health_bar_comp_5137 = asteroids.core.get_component(entity_5135,cljs.core.constant$keyword$74);var target_id_5138 = cljs.core.constant$keyword$73.cljs$core$IFn$_invoke$arity$1(health_bar_comp_5137);var target_5139 = asteroids.core.get_entity(world,target_id_5138);var target_health_comp_5140 = asteroids.core.get_component(target_5139,cljs.core.constant$keyword$72);var max_health_5141 = cljs.core.constant$keyword$70.cljs$core$IFn$_invoke$arity$1(target_health_comp_5140);var remaining_health_5142 = cljs.core.constant$keyword$71.cljs$core$IFn$_invoke$arity$1(target_health_comp_5140);var percentage_5143 = (function (){var x__3738__auto__ = 0;var y__3739__auto__ = (remaining_health_5142 / max_health_5141);return ((x__3738__auto__ > y__3739__auto__) ? x__3738__auto__ : y__3739__auto__);
