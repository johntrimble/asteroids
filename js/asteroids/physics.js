...
asteroids.physics.linear_damping = (function linear_damping(coefficient){return new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$17,cljs.core.constant$keyword$62,cljs.core.constant$keyword$61,coefficient], null);
});
...
var collidable__1 = (function (entity_ids){return new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$17,cljs.core.constant$keyword$64,cljs.core.constant$keyword$63,entity_ids], null);
});
...
{var entity_5750 = cljs.core.first(entities_5749);if(asteroids.core.has_component_QMARK_(entity_5750,cljs.core.constant$keyword$64))
...
{return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$65,asteroids.core.get_id(entity1),cljs.core.constant$keyword$66,asteroids.core.get_id(entity2),cljs.core.constant$keyword$67,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$68,r1,cljs.core.constant$keyword$69,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [1,0], null),cljs.core.constant$keyword$31,pos1], null)], null)], null);
} else
{if((d > (r1 + r2)))
{return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$65,asteroids.core.get_id(entity1),cljs.core.constant$keyword$66,asteroids.core.get_id(entity2),cljs.core.constant$keyword$67,cljs.core.PersistentVector.EMPTY], null);
} else
{if(cljs.core.constant$keyword$7)
{var normal = asteroids.vector.normalize(trans);return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$65,asteroids.core.get_id(entity1),cljs.core.constant$keyword$66,asteroids.core.get_id(entity2),cljs.core.constant$keyword$67,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$68,((r1 + r2) - d),cljs.core.constant$keyword$69,normal,cljs.core.constant$keyword$31,asteroids.vector.add(asteroids.vector.scale(r1,normal),pos1)], null)], null)], null);
} else
{return null;
}
}
...
}),cljs.core.filter((function (p1__5777_SHARP_){return asteroids.core.has_component_QMARK_(p1__5777_SHARP_,cljs.core.constant$keyword$64);
}),asteroids.core.get_entities(world))));
});
asteroids.physics.update_physics = (function update_physics(world,e){var mov = asteroids.core.get_component(e,cljs.core.constant$keyword$30);var linear_damping = asteroids.core.get_component(e,cljs.core.constant$keyword$62);var pos = asteroids.core.get_position(e);var acc = mov.acceleration;var vel = mov.velocity;var max_vel = mov.max_velocity;var max_vel__$1 = (function (){var x__3738__auto__ = (cljs.core.truth_(vel)?asteroids.vector.length(vel):0);var y__3739__auto__ = max_vel;return ((x__3738__auto__ > y__3739__auto__) ? x__3738__auto__ : y__3739__auto__);
})();var ang_acc = mov.angular_acceleration;var ang_vel = mov.angular_velocity;var ang_max_vel = mov.max_angular_velocity;var rot = asteroids.core.get_rotation(e);var new_vel = asteroids.vector.add(vel,acc);var new_vel_normal = asteroids.vector.normalize(new_vel);var new_vel__$1 = (((asteroids.vector.length(new_vel) > max_vel__$1))?asteroids.vector.scale(max_vel__$1,new_vel_normal):new_vel);var new_vel__$2 = ((((linear_damping == null)) || (asteroids.vector.zero_vector_QMARK_(new_vel__$1)))?new_vel__$1:(function (){var new_vel_mag = asteroids.vector.length(new_vel__$1);var drag_mag = (new_vel_mag * cljs.core.constant$keyword$61.cljs$core$IFn$_invoke$arity$1(linear_damping));var drag_j = asteroids.vector.scale((-1 * drag_mag),new_vel_normal);return asteroids.vector.add(new_vel__$1,drag_j);
})());var new_ang_vel = (ang_vel + ang_acc);var ang_speed = (asteroids.math.abs.cljs$core$IFn$_invoke$arity$1 ? asteroids.math.abs.cljs$core$IFn$_invoke$arity$1(new_ang_vel) : asteroids.math.abs.call(null,new_ang_vel));var new_ang_vel__$1 = (((ang_speed > ang_max_vel))?((new_ang_vel / ang_speed) * ang_max_vel):new_ang_vel);var new_pos = asteroids.vector.add(new_vel__$2,pos);var new_pos__$1 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.mod(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new_pos,0),asteroids.core.get_width(world)),cljs.core.mod(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new_pos,1),asteroids.core.get_height(world))], null);var new_rot = (new_ang_vel__$1 + rot);return asteroids.physics.update_aabb(asteroids.core.assoc_components(e,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [asteroids.core.movement(acc,new_vel__$2,mov.max_velocity,ang_acc,new_ang_vel__$1,mov.max_angular_velocity),asteroids.core.position(new_pos__$1),asteroids.core.rotation(new_rot)], null)));
});
...
}),cljs.core.filter((function (p1__5785_SHARP_){return asteroids.core.has_component_QMARK_(p1__5785_SHARP_,cljs.core.constant$keyword$64);
}),asteroids.core.get_entities(world))));
});
...
asteroids.physics.collision_physics_system = (function collision_physics_system(world){return asteroids.physics.update_with_impulse(world,asteroids.physics.handle_collisions(world,cljs.core.into(cljs.core.PersistentHashSet.EMPTY,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$2((function (e){var collides_with = cljs.core.constant$keyword$63.cljs$core$IFn$_invoke$arity$1(asteroids.core.get_component(e,cljs.core.constant$keyword$64));return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__5796_SHARP_){return cljs.core.set(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [asteroids.core.get_id(e),p1__5796_SHARP_], null));
}),collides_with);
}),cljs.core.filter((function (p1__5795_SHARP_){return cljs.core.seq(cljs.core.constant$keyword$63.cljs$core$IFn$_invoke$arity$1(asteroids.core.get_component(p1__5795_SHARP_,cljs.core.constant$keyword$64)));
}),cljs.core.filter((function (p1__5794_SHARP_){return asteroids.core.has_component_QMARK_(p1__5794_SHARP_,cljs.core.constant$keyword$64);
}),asteroids.core.get_entities(world)))))));
});
