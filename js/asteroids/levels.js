...
asteroids.levels.create_rand_asteroid = (function create_rand_asteroid(width,height){var x = cljs.core.rand_nth(cljs.core.range.cljs$core$IFn$_invoke$arity$1(width));var y = cljs.core.rand_nth(cljs.core.range.cljs$core$IFn$_invoke$arity$1(height));var r = cljs.core.rand_nth(cljs.core.range.cljs$core$IFn$_invoke$arity$2(10,25));var vx = cljs.core.rand_nth(cljs.core.range.cljs$core$IFn$_invoke$arity$2(-5,5));var vy = cljs.core.rand_nth(cljs.core.range.cljs$core$IFn$_invoke$arity$2(-5,5));var av = (0.01 * (cljs.core.rand.cljs$core$IFn$_invoke$arity$1((4 * asteroids.math.pi)) - (2 * asteroids.math.pi)));var ap = (0.01 * (cljs.core.rand.cljs$core$IFn$_invoke$arity$1((4 * asteroids.math.pi)) - (2 * asteroids.math.pi)));return asteroids.asteroids.create_asteroid(new cljs.core.PersistentArrayMap(null, 6, [cljs.core.constant$keyword$78,asteroids.util.rand_varied_color(asteroids.asteroids.asteroid_color,0.1),cljs.core.constant$keyword$31,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null),cljs.core.constant$keyword$21,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [vx,vy], null),cljs.core.constant$keyword$24,av,cljs.core.constant$keyword$32,ap,cljs.core.constant$keyword$77,r], null));
});
asteroids.levels.random_asteroid_field = (function() {
var random_asteroid_field = null;
var random_asteroid_field__0 = (function (){return random_asteroid_field.cljs$core$IFn$_invoke$arity$1(10);
});
